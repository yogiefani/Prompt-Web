      ...
      <section className="mx-auto grid min-h-[calc(100vh-112px)] max-w-6xl items-center gap-8 lg:grid-cols-[0.9fr_1.1fr]">
        <FadeIn>
          ...
          <h1 className="font-aeonik text-5xl leading-tight tracking-[-0.02em] text-[var(--color-obsidian)]">
            Aktivasi Keanggotaan {settings.brandName}.
          </h1>
          <p className="mt-5 max-w-xl text-lg font-medium leading-8 text-[var(--color-silver-pine)]">
            Selamat datang! Anda telah diundang untuk mengakses seluruh pustaka prompt premium kami.
            Silakan buat password baru di samping untuk menyelesaikan pendaftaran akun Anda.
          </p>
        </FadeIn>
